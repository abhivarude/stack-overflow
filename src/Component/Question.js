...
export default function Question(props){
    ...
    useEffect(async()=>{
        ...
        const url="https://stack-overflow-new.herokuapp.com/que/"+id;
       ...
       if(inputRef.current.value.length < 15){
        ...
        let min =0;   
         let id= Math.floor(Math.random() * (max - min) + min);
           let url="https://stack-overflow-new.herokuapp.com/que-response";
           const postData={
               responseId: id,
               queId:que.queId,
    ...
    const changeQueVotes = async(i)=>{
       ...
       let url='https://stack-overflow-new.herokuapp.com/update-que-votes/'+ que.queId;
       await axios.put(url,{
           votes:k
       },config)
    }
 ...
 //function  to cast vote to an answer.   
    const responseVote = async(e,i,j)=>{    
           ...
           let url='https://stack-overflow-new.herokuapp.com/update-resp-votes/'+ e.responseId;
           await axios.put(url,{
               votes:k
           },config)
        }
